...
List<ArticlePreviewModel> top4OtherArticles(BuildContext context) {
  List<ArticlePreviewModel> sorted = getOtherArticles(context).toList()..sort((a, b) => b.date.compareTo(a.date));
  return sorted.take(4).toList();
}

List<ArticlePreviewModel> getOtherArticles(BuildContext context) => [
      /*
      ArticlePreviewModel(
        title: 'Flutter',
        description:
